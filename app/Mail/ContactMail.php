...
class ContactMail extends Mailable
{
    ...
    {
        return new Envelope(
            subject: 'Grazie di averci contattato',   // sarebbe l'oggetto della mail
            from: new Address('alleniverson@noreply.com'), // sarebbe il mittente con la chiave from, che accetta new address , address è una classe, qund stiamo creando un oggetto
